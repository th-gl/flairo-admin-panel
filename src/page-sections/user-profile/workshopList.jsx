...
import WorkshopProfileTableHead from "@/page-sections/user-profile/workshop/WorkshopProfileTableHead.jsx";
import WorkshopProfileTableRow from "@/page-sections/user-profile/workshop/WorkshopProfileTableRow.jsx";
...
const WorkshopUserProfile = () => {
  ...
  const fetchList = useCallback(
    async (rowsPerPage, role, id) => {
      try {
        ...
        console.log("check role", response);
        if (response.success) {
          setUserProfileData(response.data);
  ...
  useEffect(() => {
    fetchProfile();
    fetchList(rowsPerPage, "workshop_id", id);
          ...
          <Box sx={{ width: "100%", typography: "body1" }}>
            <TabContext value={value}>
              ...
              >
                ...
                >
                  <Tab label={t("Service")} value="service" />
...
export default WorkshopUserProfile;
